...
const theme: PresetWind4Theme = {
  ...
  shadow: {
    card: '0 22px 55px color-mix(in oklab, var(--mc-colors-ink-950) 13%, transparent)',
    shell: [
      '0 26px 70px color-mix(in oklab, var(--mc-colors-ink-950) 14%, transparent)',
      '0 2px 8px color-mix(in oklab, var(--mc-colors-ink-950) 4%, transparent)',
    ],
    float: '0 7px 14px color-mix(in oklab, var(--mc-colors-sage-600) 18%, transparent)',
    dialog: '0 24px 60px color-mix(in oklab, var(--mc-colors-ink-950) 20%, transparent)',
    soft: '0 12px 32px color-mix(in oklab, var(--mc-colors-ochre-650) 15%, transparent)',
    focus: '0 0 0 3px color-mix(in oklab, var(--mc-colors-sage-600) 10%, transparent)',
    board: '0 4px 14px color-mix(in oklab, var(--mc-colors-board-800) 10%, transparent)',
  },
};
